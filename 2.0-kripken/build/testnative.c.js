...
function _main($argc, $argv) {
 $argc = $argc | 0;
 $argv = $argv | 0;
 var $4 = 0, $5 = 0, $8 = 0, $9 = 0, tempVarArgs = 0;
 if ((_SDL_VideoInit(0) | 0) < 0) {
  $4 = HEAP32[_stderr >> 2] | 0; //@line 107
  $5 = _SDL_GetError() | 0; //@line 108
  _fprintf($4 | 0, 56, (tempVarArgs = STACKTOP, STACKTOP = STACKTOP + 8 | 0, HEAP32[tempVarArgs >> 2] = $5, tempVarArgs) | 0) | 0; //@line 109
  STACKTOP = tempVarArgs; //@line 109
  _exit(1); //@line 110
  return 0; //@line 111
 } else {
  $8 = _SDL_GetCurrentVideoDriver() | 0; //@line 113
  $9 = HEAP32[_stderr >> 2] | 0; //@line 114
  _fprintf($9 | 0, 8, (tempVarArgs = STACKTOP, STACKTOP = STACKTOP + 8 | 0, HEAP32[tempVarArgs >> 2] = $8, tempVarArgs) | 0) | 0; //@line 115
...
function _memset(ptr, value, num) {
 ...
 stop = ptr + num | 0; //@line 182
 if ((num | 0) >= 20) {
  value = value & 255; //@line 185
  unaligned = ptr & 3; //@line 186
  value4 = value | value << 8 | value << 16 | value << 24; //@line 187
  stop4 = stop & ~3; //@line 188
  if (unaligned) {
   unaligned = ptr + 4 - unaligned | 0; //@line 190
   while ((ptr | 0) < (unaligned | 0)) {
    HEAP8[ptr] = value; //@line 192
    ptr = ptr + 1 | 0; //@line 193
   }
  }
  while ((ptr | 0) < (stop4 | 0)) {
   HEAP32[ptr >> 2] = value4; //@line 197
   ptr = ptr + 4 | 0; //@line 198
  }
 }
 while ((ptr | 0) < (stop | 0)) {
  HEAP8[ptr] = value; //@line 202
  ptr = ptr + 1 | 0; //@line 203
 }
}
function _memcpy(dest, src, num) {
 ...
 if ((dest & 3) == (src & 3)) {
  while (dest & 3) {
   if ((num | 0) == 0) return ret | 0; //@line 158
   HEAP8[dest] = HEAP8[src] | 0; //@line 159
   dest = dest + 1 | 0; //@line 160
   src = src + 1 | 0; //@line 161
   num = num - 1 | 0; //@line 162
  }
  while ((num | 0) >= 4) {
   HEAP32[dest >> 2] = HEAP32[src >> 2]; //@line 165
   dest = dest + 4 | 0; //@line 166
   src = src + 4 | 0; //@line 167
   num = num - 4 | 0; //@line 168
  }
 }
 while ((num | 0) > 0) {
  HEAP8[dest] = HEAP8[src] | 0; //@line 172
  dest = dest + 1 | 0; //@line 173
  src = src + 1 | 0; //@line 174
  num = num - 1 | 0; //@line 175
 }
 return ret | 0; //@line 177
}
function copyTempDouble(ptr) {
 ptr = ptr | 0;
...
function _quit($rc) {
 $rc = $rc | 0;
 var $1 = 0;
 _SDL_VideoQuit(); //@line 127
 $1 = HEAP32[24] | 0; //@line 128
 if (($1 | 0) == 0) {
  _exit($rc | 0); //@line 132
 }
 FUNCTION_TABLE_vi[(abort(8) | 0) & 1]($1); //@line 136
 _exit($rc | 0); //@line 138
}
...
function _strlen(ptr) {
 ...
 curr = ptr; //@line 146
 while (HEAP8[curr] | 0) {
  curr = curr + 1 | 0; //@line 148
 }
 return curr - ptr | 0; //@line 150
}
...
function dynCall_iii(index, a1, a2) {
 ...
 a1 = a1 | 0;
 a2 = a2 | 0;
 return FUNCTION_TABLE_iii[index & 1](a1 | 0, a2 | 0) | 0; //@line 228
}
function dynCall_ii(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 return FUNCTION_TABLE_ii[index & 1](a1 | 0) | 0; //@line 214
}
function dynCall_vi(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 FUNCTION_TABLE_vi[index & 1](a1 | 0); //@line 235
}
function b2(p0, p1) {
 p0 = p0 | 0;
 p1 = p1 | 0;
...
function dynCall_v(index) {
 index = index | 0;
 FUNCTION_TABLE_v[index & 1](); //@line 221
}
...
// EMSCRIPTEN_END_ASM
({ "Math": Math, "Int8Array": Int8Array, "Int16Array": Int16Array, "Int32Array": Int32Array, "Uint8Array": Uint8Array, "Uint16Array": Uint16Array, "Uint32Array": Uint32Array, "Float32Array": Float32Array, "Float64Array": Float64Array }, { "abort": abort, "assert": assert, "asmPrintInt": asmPrintInt, "asmPrintFloat": asmPrintFloat, "min": Math_min, "invoke_ii": invoke_ii, "invoke_v": invoke_v, "invoke_iii": invoke_iii, "invoke_vi": invoke_vi, "_malloc": _malloc, "_pwrite": _pwrite, "_llvm_dbg_value": _llvm_dbg_value, "___setErrNo": ___setErrNo, "_fwrite": _fwrite, "__reallyNegative": __reallyNegative, "__formatString": __formatString, "_send": _send, "_SDL_GetCurrentVideoDriver": _SDL_GetCurrentVideoDriver, "_write": _write, "_SDL_VideoInit": _SDL_VideoInit, "_fprintf": _fprintf, "_free": _free, "_SDL_GetError": _SDL_GetError, "_exit": _exit, "_fflush": _fflush, "_SDL_VideoQuit": _SDL_VideoQuit, "__exit": __exit, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "NaN": NaN, "Infinity": Infinity, "_stderr": _stderr }, buffer);
...
// {{POST_RUN_ADDITIONS}}
// {{MODULE_ADDITIONS}}
//@ sourceMappingURL=testnative.c.js.map