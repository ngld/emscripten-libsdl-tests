...
/* memory initializer */ allocate([78,111,32,79,112,101,110,71,76,32,115,117,112,112,111,114,116,32,111,110,32,116,104,105,115,32,115,121,115,116,101,109,0,0,0,0,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE)
...
function _memset(ptr, value, num) {
 ...
 stop = ptr + num | 0; //@line 147
 if ((num | 0) >= 20) {
  value = value & 255; //@line 150
  unaligned = ptr & 3; //@line 151
  value4 = value | value << 8 | value << 16 | value << 24; //@line 152
  stop4 = stop & ~3; //@line 153
  if (unaligned) {
   unaligned = ptr + 4 - unaligned | 0; //@line 155
   while ((ptr | 0) < (unaligned | 0)) {
    HEAP8[ptr] = value; //@line 157
    ptr = ptr + 1 | 0; //@line 158
   }
  }
  while ((ptr | 0) < (stop4 | 0)) {
   HEAP32[ptr >> 2] = value4; //@line 162
   ptr = ptr + 4 | 0; //@line 163
  }
 }
 while ((ptr | 0) < (stop | 0)) {
  HEAP8[ptr] = value; //@line 167
  ptr = ptr + 1 | 0; //@line 168
 }
}
function _memcpy(dest, src, num) {
 ...
 if ((dest & 3) == (src & 3)) {
  while (dest & 3) {
   if ((num | 0) == 0) return ret | 0; //@line 123
   HEAP8[dest] = HEAP8[src] | 0; //@line 124
   dest = dest + 1 | 0; //@line 125
   src = src + 1 | 0; //@line 126
   num = num - 1 | 0; //@line 127
  }
  while ((num | 0) >= 4) {
   HEAP32[dest >> 2] = HEAP32[src >> 2]; //@line 130
   dest = dest + 4 | 0; //@line 131
   src = src + 4 | 0; //@line 132
   num = num - 4 | 0; //@line 133
  }
 }
 while ((num | 0) > 0) {
  HEAP8[dest] = HEAP8[src] | 0; //@line 137
  dest = dest + 1 | 0; //@line 138
  src = src + 1 | 0; //@line 139
  num = num - 1 | 0; //@line 140
 }
 return ret | 0; //@line 142
}
function copyTempDouble(ptr) {
 ptr = ptr | 0;
...
function _strlen(ptr) {
 ...
 curr = ptr; //@line 111
 while (HEAP8[curr] | 0) {
  curr = curr + 1 | 0; //@line 113
 }
 return curr - ptr | 0; //@line 115
}
...
function dynCall_iii(index, a1, a2) {
 ...
 a1 = a1 | 0;
 a2 = a2 | 0;
 return FUNCTION_TABLE_iii[index & 1](a1 | 0, a2 | 0) | 0; //@line 193
}
function dynCall_ii(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 return FUNCTION_TABLE_ii[index & 1](a1 | 0) | 0; //@line 179
}
function _main($argc, $argv) {
 $argc = $argc | 0;
 $argv = $argv | 0;
 _puts(8 | 0) | 0; //@line 102
 return 1; //@line 104
}
function dynCall_vi(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 FUNCTION_TABLE_vi[index & 1](a1 | 0); //@line 200
}
function b2(p0, p1) {
 p0 = p0 | 0;
 p1 = p1 | 0;
...
function dynCall_v(index) {
 index = index | 0;
 FUNCTION_TABLE_v[index & 1](); //@line 186
}
...
// EMSCRIPTEN_END_ASM
({ "Math": Math, "Int8Array": Int8Array, "Int16Array": Int16Array, "Int32Array": Int32Array, "Uint8Array": Uint8Array, "Uint16Array": Uint16Array, "Uint32Array": Uint32Array, "Float32Array": Float32Array, "Float64Array": Float64Array }, { "abort": abort, "assert": assert, "asmPrintInt": asmPrintInt, "asmPrintFloat": asmPrintFloat, "min": Math_min, "invoke_ii": invoke_ii, "invoke_v": invoke_v, "invoke_iii": invoke_iii, "invoke_vi": invoke_vi, "_fputc": _fputc, "_malloc": _malloc, "_pwrite": _pwrite, "_puts": _puts, "_llvm_dbg_value": _llvm_dbg_value, "___setErrNo": ___setErrNo, "_send": _send, "_write": _write, "_fputs": _fputs, "_free": _free, "_fflush": _fflush, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "NaN": NaN, "Infinity": Infinity }, buffer);
...
// {{POST_RUN_ADDITIONS}}
// {{MODULE_ADDITIONS}}
//@ sourceMappingURL=testshader.c.js.map