...
function _memset(ptr, value, num) {
 ...
 stop = ptr + num | 0; //@line 125
 if ((num | 0) >= 20) {
  value = value & 255; //@line 128
  unaligned = ptr & 3; //@line 129
  value4 = value | value << 8 | value << 16 | value << 24; //@line 130
  stop4 = stop & ~3; //@line 131
  if (unaligned) {
   unaligned = ptr + 4 - unaligned | 0; //@line 133
   while ((ptr | 0) < (unaligned | 0)) {
    HEAP8[ptr] = value; //@line 135
    ptr = ptr + 1 | 0; //@line 136
   }
  }
  while ((ptr | 0) < (stop4 | 0)) {
   HEAP32[ptr >> 2] = value4; //@line 140
   ptr = ptr + 4 | 0; //@line 141
  }
 }
 while ((ptr | 0) < (stop | 0)) {
  HEAP8[ptr] = value; //@line 145
  ptr = ptr + 1 | 0; //@line 146
 }
}
function _memcpy(dest, src, num) {
 ...
 if ((dest & 3) == (src & 3)) {
  while (dest & 3) {
   if ((num | 0) == 0) return ret | 0; //@line 101
   HEAP8[dest] = HEAP8[src] | 0; //@line 102
   dest = dest + 1 | 0; //@line 103
   src = src + 1 | 0; //@line 104
   num = num - 1 | 0; //@line 105
  }
  while ((num | 0) >= 4) {
   HEAP32[dest >> 2] = HEAP32[src >> 2]; //@line 108
   dest = dest + 4 | 0; //@line 109
   src = src + 4 | 0; //@line 110
   num = num - 4 | 0; //@line 111
  }
 }
 while ((num | 0) > 0) {
  HEAP8[dest] = HEAP8[src] | 0; //@line 115
  dest = dest + 1 | 0; //@line 116
  src = src + 1 | 0; //@line 117
  num = num - 1 | 0; //@line 118
 }
 return ret | 0; //@line 120
}
function copyTempDouble(ptr) {
 ptr = ptr | 0;
...
function _strlen(ptr) {
 ...
 curr = ptr; //@line 152
 while (HEAP8[curr] | 0) {
  curr = curr + 1 | 0; //@line 154
 }
 return curr - ptr | 0; //@line 156
}
...
function dynCall_iii(index, a1, a2) {
 ...
 a1 = a1 | 0;
 a2 = a2 | 0;
 return FUNCTION_TABLE_iii[index & 1](a1 | 0, a2 | 0) | 0; //@line 180
}
function dynCall_ii(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 return FUNCTION_TABLE_ii[index & 1](a1 | 0) | 0; //@line 166
}
function dynCall_vi(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 FUNCTION_TABLE_vi[index & 1](a1 | 0); //@line 187
}
function b2(p0, p1) {
 p0 = p0 | 0;
 p1 = p1 | 0;
...
function dynCall_v(index) {
 index = index | 0;
 FUNCTION_TABLE_v[index & 1](); //@line 173
}
...
// {{POST_RUN_ADDITIONS}}
// {{MODULE_ADDITIONS}}
//@ sourceMappingURL=testnativex11.c.js.map