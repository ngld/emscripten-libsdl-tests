...
/* memory initializer */ allocate([78,111,32,79,112,101,110,71,76,32,69,83,32,115,117,112,112,111,114,116,32,111,110,32,116,104,105,115,32,115,121,115,116,101,109,10,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE)
...
function _main($argc,$argv){
 ...
 $2=$argc;
 $3=$argv;
 var $4=_printf(8,(tempVarArgs=STACKTOP,STACKTOP = (STACKTOP + 1)|0,STACKTOP = (((STACKTOP)+7)&-8),(assert((STACKTOP|0) < (STACK_MAX|0))|0),HEAP32[((tempVarArgs)>>2)]=0,tempVarArgs)); STACKTOP=tempVarArgs;
...
// {{POST_RUN_ADDITIONS}}
// {{MODULE_ADDITIONS}}
//@ sourceMappingURL=testgles.test.js.map