...
/* memory initializer */ allocate([83,68,76,32,99,111,109,112,105,108,101,100,32,119,105,116,104,111,117,116,32,74,111,121,115,116,105,99,107,32,115,117,112,112,111,114,116,46,10,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE)
...
function _memset(ptr, value, num) {
 ...
 stop = ptr + num | 0; //@line 139
 if ((num | 0) >= 20) {
  value = value & 255; //@line 142
  unaligned = ptr & 3; //@line 143
  value4 = value | value << 8 | value << 16 | value << 24; //@line 144
  stop4 = stop & ~3; //@line 145
  if (unaligned) {
   unaligned = ptr + 4 - unaligned | 0; //@line 147
   while ((ptr | 0) < (unaligned | 0)) {
    HEAP8[ptr] = value; //@line 149
    ptr = ptr + 1 | 0; //@line 150
   }
  }
  while ((ptr | 0) < (stop4 | 0)) {
   HEAP32[ptr >> 2] = value4; //@line 154
   ptr = ptr + 4 | 0; //@line 155
  }
 }
 while ((ptr | 0) < (stop | 0)) {
  HEAP8[ptr] = value; //@line 159
  ptr = ptr + 1 | 0; //@line 160
 }
}
function _memcpy(dest, src, num) {
 ...
 if ((dest & 3) == (src & 3)) {
  while (dest & 3) {
   if ((num | 0) == 0) return ret | 0; //@line 115
   HEAP8[dest] = HEAP8[src] | 0; //@line 116
   dest = dest + 1 | 0; //@line 117
   src = src + 1 | 0; //@line 118
   num = num - 1 | 0; //@line 119
  }
  while ((num | 0) >= 4) {
   HEAP32[dest >> 2] = HEAP32[src >> 2]; //@line 122
   dest = dest + 4 | 0; //@line 123
   src = src + 4 | 0; //@line 124
   num = num - 4 | 0; //@line 125
  }
 }
 while ((num | 0) > 0) {
  HEAP8[dest] = HEAP8[src] | 0; //@line 129
  dest = dest + 1 | 0; //@line 130
  src = src + 1 | 0; //@line 131
  num = num - 1 | 0; //@line 132
 }
 return ret | 0; //@line 134
}
function copyTempDouble(ptr) {
 ptr = ptr | 0;
...
function _strlen(ptr) {
 ...
 curr = ptr; //@line 166
 while (HEAP8[curr] | 0) {
  curr = curr + 1 | 0; //@line 168
 }
 return curr - ptr | 0; //@line 170
}
function _main($argc, $argv) {
 $argc = $argc | 0;
 $argv = $argv | 0;
 _fwrite(8, 39, 1, HEAP32[_stderr >> 2] | 0) | 0; //@line 103
 _exit(1); //@line 104
 return 0; //@line 105
}
...
function dynCall_iii(index, a1, a2) {
 ...
 a1 = a1 | 0;
 a2 = a2 | 0;
 return FUNCTION_TABLE_iii[index & 1](a1 | 0, a2 | 0) | 0; //@line 194
}
function dynCall_ii(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 return FUNCTION_TABLE_ii[index & 1](a1 | 0) | 0; //@line 180
}
function dynCall_vi(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 FUNCTION_TABLE_vi[index & 1](a1 | 0); //@line 201
}
function b2(p0, p1) {
 p0 = p0 | 0;
 p1 = p1 | 0;
...
function dynCall_v(index) {
 index = index | 0;
 FUNCTION_TABLE_v[index & 1](); //@line 187
}
...
// {{POST_RUN_ADDITIONS}}
// {{MODULE_ADDITIONS}}
//@ sourceMappingURL=testgamecontroller.c.js.map