...
/* memory initializer */ allocate([67,111,109,112,105,108,101,100,32,119,105,116,104,32,83,68,76,32,111,108,100,101,114,32,116,104,97,110,32,50,46,48,0,0,0,0,0,0,0,0,76,105,110,107,101,100,32,118,101,114,115,105,111,110,58,32,37,100,46,37,100,46,37,100,46,37,100,32,40,37,115,41,10,0,0,0,0,0,0,0,104,103,45,53,54,48,53,58,57,50,54,57,98,102,57,53,50,48,52,49,0,0,0,0,67,111,109,112,105,108,101,100,32,118,101,114,115,105,111,110,58,32,37,100,46,37,100,46,37,100,46,37,100,32,40,37,115,41,10,0,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE)
...
function copyTempDouble(ptr) {
  ...
  function _SDL_GetVersion() {
  Module['printErr']('missing function: SDL_GetVersion'); abort(-1);
  }
  function _SDL_GetRevisionNumber() {
  Module['printErr']('missing function: SDL_GetRevisionNumber'); abort(-1);
  }
  function _SDL_GetRevision() {
  Module['printErr']('missing function: SDL_GetRevision'); abort(-1);
  }
...
var asm = (function(global, env, buffer) {
  ...
  var _SDL_GetRevision=env._SDL_GetRevision;
  var _SDL_GetVersion=env._SDL_GetVersion;
  var __formatString=env.__formatString;
  var _free=env._free;
  var _SDL_GetRevisionNumber=env._SDL_GetRevisionNumber;
...
function _main($argc, $argv) {
 $argc = $argc | 0;
 $argv = $argv | 0;
 var $linked = 0, $4 = 0, $7 = 0, $10 = 0, $11 = 0, $12 = 0, tempVarArgs = 0, sp = 0;
 sp = STACKTOP; //@line 103
 STACKTOP = STACKTOP + 8 | 0; //@line 103
 $linked = sp | 0; //@line 104
 _puts(8) | 0; //@line 105
 _printf(112, (tempVarArgs = STACKTOP, STACKTOP = STACKTOP + 40 | 0, HEAP32[tempVarArgs >> 2] = 1, HEAP32[tempVarArgs + 8 >> 2] = 3, HEAP32[tempVarArgs + 16 >> 2] = 0, HEAP32[tempVarArgs + 24 >> 2] = 5605, HEAP32[tempVarArgs + 32 >> 2] = 88, tempVarArgs) | 0) | 0; //@line 106
 STACKTOP = tempVarArgs; //@line 106
 _SDL_GetVersion($linked | 0); //@line 107
 $4 = HEAPU8[$linked | 0] | 0; //@line 110
 $7 = HEAPU8[$linked + 1 | 0] | 0; //@line 113
 $10 = HEAPU8[$linked + 2 | 0] | 0; //@line 116
 $11 = _SDL_GetRevisionNumber() | 0; //@line 117
 $12 = _SDL_GetRevision() | 0; //@line 118
 _printf(48, (tempVarArgs = STACKTOP, STACKTOP = STACKTOP + 40 | 0, HEAP32[tempVarArgs >> 2] = $4, HEAP32[tempVarArgs + 8 >> 2] = $7, HEAP32[tempVarArgs + 16 >> 2] = $10, HEAP32[tempVarArgs + 24 >> 2] = $11, HEAP32[tempVarArgs + 32 >> 2] = $12, tempVarArgs) | 0) | 0; //@line 119
...
function _memset(ptr, value, num) {
 ...
 stop = ptr + num | 0; //@line 165
 if ((num | 0) >= 20) {
  value = value & 255; //@line 168
  unaligned = ptr & 3; //@line 169
  value4 = value | value << 8 | value << 16 | value << 24; //@line 170
  stop4 = stop & ~3; //@line 171
  if (unaligned) {
   unaligned = ptr + 4 - unaligned | 0; //@line 173
   while ((ptr | 0) < (unaligned | 0)) {
    HEAP8[ptr] = value; //@line 175
    ptr = ptr + 1 | 0; //@line 176
   }
  }
  while ((ptr | 0) < (stop4 | 0)) {
   HEAP32[ptr >> 2] = value4; //@line 180
   ptr = ptr + 4 | 0; //@line 181
  }
 }
 while ((ptr | 0) < (stop | 0)) {
  HEAP8[ptr] = value; //@line 185
  ptr = ptr + 1 | 0; //@line 186
 }
}
function _memcpy(dest, src, num) {
 ...
 if ((dest & 3) == (src & 3)) {
  while (dest & 3) {
   if ((num | 0) == 0) return ret | 0; //@line 141
   HEAP8[dest] = HEAP8[src] | 0; //@line 142
   dest = dest + 1 | 0; //@line 143
   src = src + 1 | 0; //@line 144
   num = num - 1 | 0; //@line 145
  }
  while ((num | 0) >= 4) {
   HEAP32[dest >> 2] = HEAP32[src >> 2]; //@line 148
   dest = dest + 4 | 0; //@line 149
   src = src + 4 | 0; //@line 150
   num = num - 4 | 0; //@line 151
  }
 }
 while ((num | 0) > 0) {
  HEAP8[dest] = HEAP8[src] | 0; //@line 155
  dest = dest + 1 | 0; //@line 156
  src = src + 1 | 0; //@line 157
  num = num - 1 | 0; //@line 158
 }
 return ret | 0; //@line 160
}
function copyTempDouble(ptr) {
 ptr = ptr | 0;
...
function _strlen(ptr) {
 ...
 curr = ptr; //@line 129
 while (HEAP8[curr] | 0) {
  curr = curr + 1 | 0; //@line 131
 }
 return curr - ptr | 0; //@line 133
}
...
function dynCall_iii(index, a1, a2) {
 ...
 a1 = a1 | 0;
 a2 = a2 | 0;
 return FUNCTION_TABLE_iii[index & 1](a1 | 0, a2 | 0) | 0; //@line 211
}
function dynCall_ii(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 return FUNCTION_TABLE_ii[index & 1](a1 | 0) | 0; //@line 197
}
function dynCall_vi(index, a1) {
 index = index | 0;
 a1 = a1 | 0;
 FUNCTION_TABLE_vi[index & 1](a1 | 0); //@line 218
}
function b2(p0, p1) {
 p0 = p0 | 0;
 p1 = p1 | 0;
...
function dynCall_v(index) {
 index = index | 0;
 FUNCTION_TABLE_v[index & 1](); //@line 204
}
